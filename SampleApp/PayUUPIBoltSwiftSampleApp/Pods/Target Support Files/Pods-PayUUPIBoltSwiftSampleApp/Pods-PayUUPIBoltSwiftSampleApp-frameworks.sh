...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/PayUIndia-UPIBoltBaseKit/PayUUPIBoltBaseKit.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/PayUIndia-UPIBoltKit/PayUUPIBoltKit.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/PayUIndia-UPIBoltUIKit/PayUUPIBoltUIKit.framework"
fi
