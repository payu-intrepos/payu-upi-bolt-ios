...
- (void)removeAccountWithAccountDetail:(PayUUPIBoltAccountDetail * _Nonnull)accountDetail requestType:(NSString * _Nonnull)requestType callback:(void (^ _Nonnull)(PayUUPIBoltResponse * _Nonnull))callback;
