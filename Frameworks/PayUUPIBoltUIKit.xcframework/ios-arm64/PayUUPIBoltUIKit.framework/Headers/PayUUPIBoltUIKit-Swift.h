...
@protocol PayUUPIBoltUIDelegate <PayUUPIBoltHashDelegate>
...
- (void)isUPIBoltSDKAvailableWithCallback:(void (^ _Nonnull)(PayUUPIBoltResponse * _Nonnull))callback;
- (void)registerAndPayWithPaymentParams:(PayUUPIBoltPaymentParams * _Nonnull)paymentParams;
- (void)openUPIManagementWithScreenType:(enum PayUUPIBoltUIScreenType)screenType;
- (void)registerAndPayWithPaymentParamsJSON:(id _Nullable)paymentParamsJSON;
- (void)openUPIManagementWithScreenTypeString:(id _Nullable)screenTypeString;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
